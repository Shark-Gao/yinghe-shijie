globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-DZ7hVyDO.js","assets/layout-segment-context-C5NnaPc5.js"];
...
function getDraftSecret() {
	return "40d519a2-ed44-4702-8f3c-f3cc9ba3e743";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "590c1fc3-ef09-423e-8112-29ed183b4514";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "590c1fc3-ef09-423e-8112-29ed183b4514") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "590c1fc3-ef09-423e-8112-29ed183b4514",
		rootBoundaryId
	});
}
/**
...
var metadata = {
	title: "硬核视界｜多平台复盘看板",
	description: "硬核视界短视频多平台数据基线、复盘与优化建议。",
	openGraph: {
		title: "硬核视界｜多平台复盘看板",
		description: "别只看播放量，看清内容在哪一段掉了。",
		images: ["/og.png"]
	},
	twitter: {
